...
import com.example.organizze.activity.adapter.AdapterMovimentação;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    private AdapterMovimentação adapterMovimentaçao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //configurar adapter
        adapterMovimentaçao = new AdapterMovimentação(movimentacoes, this);
        ...
        recyclerView.setAdapter(adapterMovimentaçao);
    ...
    public void excluirMovimentacao(RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setTitle("Excluir Movimentção da Conta");
        ...
        alertDialog.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                adapterMovimentaçao.notifyItemRemoved( position );
        ...
        alertDialog.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                adapterMovimentaçao.notifyDataSetChanged();
